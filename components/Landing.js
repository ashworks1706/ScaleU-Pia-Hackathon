...
export default function Landing() {
  return (
    ...
    <section
      id="home"
      className="flex-1 flex flex-col justify-center items-center text-center py-20 relative overflow-hidden"
    >
      {/* Background Gradient */}
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <p className="text-gray-400 text-lg mb-8">
          Leverage real-time transcription, semantic search, and AI
          assistance to make academic collaboration more effective and
          accessible.
        </p>
          ...
          {[
            {
              ...
              description:
                "Find relevant discussions using advanced semantic search.",
            },
            {
              icon: "🎥",
              title: "Real-Time Zoom Integration",
              description:
                "Join live discussions directly from search results.",
            },
            {
              icon: "🧠",
              title: "AI Assistance",
              description:
                "Get real-time explanations and clarifications.",
            },
            {
              icon: "💬",
    ...
    <footer className="border-t border-gray-800 py-12 bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              AI-powered collaborative Zoom sessions enhanced by real-time
              semantic search and multimodal learning.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} ZoomSenseAI. All rights
          reserved.
        </div>
      </div>
    </footer>
